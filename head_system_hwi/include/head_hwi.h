...
int32_t head_hwi_is_mx_torque_on(uint32_t uid, double *is_on);

int32_t head_hwi_set_mx_torque(uint32_t uid, double *on);

int32_t head_hwi_get_mx_pid(uint32_t uid, double *p, double *i, double *d);

int32_t head_hwi_set_mx_pid(uint32_t uid, double *p, double *i, double *d);
